...
spine.temp = new spine.Float32Array(2), spine.BoneData = function (a, b) {
    ...
    inheritScale: !0,
    inheritRotation: !0
}, spine.BlendMode = {normal: 0, additive: 1, multiply: 2, screen: 3}, spine.SlotData = function (a, b) {
    ...
    updateWorldTransform: function (a, b, c, d, e) {
        ...
        var f = Math.cos(c), g = Math.sin(c), h = f * d, i = -g * e, j = g * d, k = f * e, l = this.parent;
        if (!l) {
            var m = this.skeleton;
        ...
        var n = l.a, o = l.b, p = l.c, q = l.d;
        if (this.worldX = n * a + o * b + l.worldX, this.worldY = p * a + q * b + l.worldY, this.worldSignX = l.worldSignX * (0 > d ? -1 : 1), this.worldSignY = l.worldSignY * (0 > e ? -1 : 1), this.data.inheritRotation && this.data.inheritScale) this.a = n * h + o * j, this.b = n * i + o * k, this.c = p * h + q * j, this.d = p * i + q * k; else {
            if (this.data.inheritRotation) {
                ...
                do {
                    c = l.appliedRotation * spine.degRad, f = Math.cos(c), g = Math.sin(c);
                    var s = l.appliedScaleX, t = l.appliedScaleY, u = f * s, v = -g * t, w = g * s, x = f * t,
                        r = n * u + o * w;
    ...
    worldToLocal: function (a) {
        var b = a[0] - this.worldX, c = a[1] - this.worldY, d = this.a, e = this.b, f = this.c, g = this.d,
            h = 1 / (d * g - e * f);
    ...
    var e = a.parent ? a.parent.getWorldRotationX() : 0, f = a.rotation,
    ...
    if (0 != f) {
        ...
        var n = b.x, o = b.y, p = b.appliedScaleX, q = Math.abs(l - m) <= 1e-4;
        q || 0 == o || (b.worldX = a.a * n + a.worldX, b.worldY = a.c * n + a.worldY, o = 0), 0 > p ? (p = -p, h = 180) : h = 0;
        var r, s, t, u, v = a.parent;
        if (v) {
            var w = v.a, x = v.b, y = v.c, z = v.d, A = 1 / (w * z - x * y), B = v.worldX, C = v.worldY, D = c - B,
                E = d - C;
        ...
        a:if (q) {
            ...
            var w = H + I * J, K = I * Math.sin(G);
            F = Math.atan2(s * w - r * K, r * w + s * K)
        } else {
            var w = l * I, x = m * I, L = Math.atan2(s, r), M = w * w, N = x * x, O = H * H, P = r * r + s * s,
                Q = N * O + M * P - M * N, R = -2 * N * H, S = N - M, z = R * R - 4 * S * Q;
            if (z >= 0) {
                var T = Math.sqrt(z);
                0 > R && (T = -T), T = -(R + T) / 2;
                var U = T / S, V = Q / T, W = Math.abs(U) < Math.abs(V) ? U : V;
                if (P >= W * W) {
            ...
            var X = 0, Y = Number.MAX_VALUE, Z = 0, $ = 0, _ = 0, aa = 0, ba = 0, ca = 0, D = H + w, da = D * D;
    ...
    setLinear: function (a) {
        ...
        var f = .1, g = f * f, h = g * f, i = 3 * f, j = 3 * g, k = 6 * g, l = 6 * h, m = 2 * -b + d, n = 2 * -c + e,
            o = 3 * (b - d) + 1, p = 3 * (c - e) + 1, q = b * i + m * j + o * h, r = c * i + n * j + p * h,
            s = m * k + o * l, t = n * k + p * l, u = o * l, v = p * l, w = 19 * a, x = this.curves;
        x[w++] = 2;
    ...
    boneIndex: 0, getFrameCount: function () {
        ...
        if (!(c < f[0])) {
            ...
            var i = spine.Animation.binarySearch(f, c, 2), j = f[i - 1], k = f[i], l = 1 - (c - k) / (f[i - 2] - k);
    ...
    boneIndex: 0, getFrameCount: function () {
        ...
        if (!(c < f[0])) {
            ...
            var h = spine.Animation.binarySearch(f, c, 3), i = f[h - 2], j = f[h - 1], k = f[h],
                l = 1 - (c - k) / (f[h + -3] - k);
    ...
    slotIndex: 0, getFrameCount: function () {
        ...
        if (!(c < f[0])) {
            ...
            if (c >= f[f.length - 5]) {
                ...
                var l = spine.Animation.binarySearch(f, c, 5), m = f[l - 4], n = f[l - 3], o = f[l - 2], p = f[l - 1],
                    q = f[l], r = 1 - (c - q) / (f[l - 5] - q);
    ...
    getFrameCount: function () {
        ...
        if (d) {
            var f = this.frames, g = f.length;
            if (b > c) this.apply(a, b, Number.MAX_VALUE, d, e), b = -1; else if (b >= f[g - 1]) return;
            if (!(c < f[0])) {
                var h;
                if (b < f[0]) h = 0; else {
    ...
    getFrameCount: function () {
        ...
        if (!(c < f[0])) {
            ...
            var h = a.drawOrder, i = a.slots, j = this.drawOrders[g];
            if (j) for (var k = 0, l = j.length; l > k; k++) h[k] = a.slots[j[k]]; else for (var k = 0, l = i.length; l > k; k++) h[k] = i[k]
        }
    }
    ...
    slotIndex: 0, attachment: 0, getFrameCount: function () {
        ...
        var f = a.slots[this.slotIndex], g = f.attachment;
        if (g && (g == this.attachment || g.inheritFFD && g.parentMesh == this.attachment)) {
            var h = this.frames;
            if (!(c < h[0])) {
                var i = this.frameVertices, j = i[0].length, k = f.attachmentVertices;
                if (k.length != j && (f.attachmentVertices = k = new spine.Float32Array(j), e = 1), c >= h[h.length - 1]) {
                    var l = i[h.length - 1];
                    if (1 > e) for (var m = 0; j > m; m++) k[m] += (l[m] - k[m]) * e; else for (var m = 0; j > m; m++) k[m] = l[m]
                } else {
                    var n = spine.Animation.binarySearch1(h, c), o = h[n], p = 1 - (c - o) / (h[n - 1] - o);
    ...
    ikConstraintIndex: 0, getFrameCount: function () {
        ...
        if (!(c < f[0])) {
            ...
            var h = spine.Animation.binarySearch(f, c, 3), i = f[h + -2], j = f[h], k = 1 - (c - j) / (f[h + -3] - j);
    ...
    for (var b = 0, c = a.slots.length; c > b; b++) {
        var f = a.slots[b], g = this.bones[a.bones.indexOf(f.boneData)], h = new spine.Slot(f, g);
    ...
    updateCache: function () {
        var a = this.bones, b = this.cache, c = this.ikConstraints, d = this.transformConstraints, e = c.length,
            f = d.length;
        b.length = 0;
    ...
    this.name = a
}, spine.EventData.prototype = {intValue: 0, floatValue: 0, stringValue: null}, spine.Event = function (a, b) {
    ...
    updateOffset: function () {
        var a = this.width / this.regionOriginalWidth * this.scaleX,
            ...
            f = d + this.regionHeight * b, g = this.rotation * spine.degRad, h = Math.cos(g), i = Math.sin(g),
    ...
    computeVertices: function (a, b, c, d) {
        ...
        var e = c.a, f = c.b, g = c.c, h = c.d, i = this.offset;
    ...
    height: 0,
    updateUVs: function () {
        var a = this.regionU2 - this.regionU, b = this.regionV2 - this.regionV, c = this.regionUVs.length;
        if (this.uvs && this.uvs.length == c || (this.uvs = new spine.Float32Array(c)), this.regionRotate) for (var d = 0; c > d; d += 2) this.uvs[d] = this.regionU + this.regionUVs[d + 1] * a, this.uvs[d + 1] = this.regionV + b - this.regionUVs[d] * b; else for (var d = 0; c > d; d += 2) this.uvs[d] = this.regionU + this.regionUVs[d] * a, this.uvs[d + 1] = this.regionV + this.regionUVs[d + 1] * b
    },
    computeWorldVertices: function (a, b, c, d) {
        var e = c.bone;
        a += e.worldX, b += e.worldY;
        var f = e.a, g = e.b, h = e.c, i = e.d, j = this.vertices, k = j.length;
    ...
    updateUVs: function (a, b, c, d, e) {
        var f = this.regionU2 - this.regionU, g = this.regionV2 - this.regionV, h = this.regionUVs.length;
        if (this.uvs && this.uvs.length == h || (this.uvs = new spine.Float32Array(h)), this.regionRotate) for (var i = 0; h > i; i += 2) this.uvs[i] = this.regionU + this.regionUVs[i + 1] * f, this.uvs[i + 1] = this.regionV + g - this.regionUVs[i] * g; else for (var i = 0; h > i; i += 2) this.uvs[i] = this.regionU + this.regionUVs[i] * f, this.uvs[i + 1] = this.regionV + this.regionUVs[i + 1] * g
    },
    computeWorldVertices: function (a, b, c, d) {
        var e, f, g, h, i, j, k, l = c.bone.skeleton.bones, m = this.weights, n = this.bones, o = 0, p = 0, q = 0,
            r = 0, s = n.length;
    ...
    scale: 1, readSkeletonData: function (a, b) {
        ...
        if (q) for (var f = 0, g = q.length; g > f; f++) {
            var r = q[f], s = new spine.TransformConstraintData(r.name);
        ...
        for (var t = a.slots, f = 0, g = t.length; g > f; f++) {
            var u = t[f], j = c.findBone(u.bone);
            if (!j) throw"Slot bone not found: " + u.bone;
            var v = new spine.SlotData(u.name, j), w = u.color;
        ...
        for (var y in x) if (x.hasOwnProperty(y)) {
            var z = x[y], A = new spine.Skin(y);
            for (var B in z) if (z.hasOwnProperty(B)) {
                var C = c.findSlotIndex(B), D = z[B];
        ...
        for (var f = 0, g = this.linkedMeshes.length; g > f; f++) {
            var G = this.linkedMeshes[f], A = G.skin ? c.findSkin(G.skin) : c.defaultSkin;
        ...
        for (var I in H) if (H.hasOwnProperty(I)) {
            var J = H[I], K = new spine.EventData(I);
            ...
            for (var j in h) if (h.hasOwnProperty(j)) {
                ...
                if ("color" == j) {
                    ...
                    for (var m = 0, n = 0, o = k.length; o > n; n++) {
                        var p = k[n], q = p.color, r = this.toColor(q, 0), s = this.toColor(q, 1),
                            t = this.toColor(q, 2), u = this.toColor(q, 3);
        ...
        for (var D in C) if (C.hasOwnProperty(D)) {
            var E = c.findIkConstraint(D), k = C[D], l = new spine.IkConstraintTimeline(k.length);
            l.ikConstraintIndex = c.ikConstraints.indexOf(E);
            for (var m = 0, n = 0, o = k.length; o > n; n++) {
                var p = k[n], F = p.hasOwnProperty("mix") ? p.mix : 1,
        ...
        var H = b.ffd;
        for (var I in H) {
            var J = c.findSkin(I), h = H[I];
            for (g in h) {
                var i = c.findSlotIndex(g), K = h[g];
                for (var L in K) {
                    var k = K[L], l = new spine.FfdTimeline(k.length), M = J.getAttachment(i, L);
                    ...
                    for (var m = 0, n = 0, o = k.length; o > n; n++) {
                        var P, p = k[n];
                        if (p.vertices) {
                            var Q = p.vertices, P = new spine.Float32Array(N);
                            P.length = N;
                            var R = p.offset || 0, S = Q.length;
                            if (1 == this.scale) for (var T = 0; S > T; T++) P[T + R] = Q[T]; else for (var T = 0; S > T; T++) P[T + R] = Q[T] * this.scale;
        ...
        if (V || (V = b.draworder), V) {
            for (var l = new spine.DrawOrderTimeline(V.length), W = c.slots.length, m = 0, n = 0, o = V.length; o > n; n++) {
                ...
                if (X.offsets) {
                    ...
                    var Z = X.offsets, $ = new spine.Uint32Array(W - Z.length);
                    $.length = W - Z.length;
                    for (var _ = 0, aa = 0, T = 0, S = Z.length; S > T; T++) {
                        var ba = Z[T], i = c.findSlotIndex(ba.slot);
        ...
        if (ca) {
            for (var l = new spine.EventTimeline(ca.length), m = 0, n = 0, o = ca.length; o > n; n++) {
                var da = ca[n], ea = c.findEvent(da.name);
        ...
        var d = a[b], e = new spine.Float32Array(d.length), f = 0, g = d.length;
        if (1 == c) for (; g > f; f++) e[f] = d[f]; else for (; g > f; f++) e[f] = d[f] * c;
        return e
    ...
    var c = new spine.AtlasReader(a), d = [];
    d.length = 4;
    for (var e = null; ;) {
        var f = c.readLine();
        if (null === f) break;
        if (f = c.trim(f), f.length) if (e) {
            ...
            var h = parseInt(d[0]), i = parseInt(d[1]);
            c.readTuple(d);
            var j = parseInt(d[0]), k = parseInt(d[1]);
    ...
    minX: 0, minY: 0, maxX: 0, maxY: 0, update: function (a, b) {
        var c = a.slots, d = c.length, e = a.x, f = a.y, g = this.boundingBoxes, h = this.polygonPool,
            i = this.polygons;
        g.length = 0;
        for (var j = 0, k = i.length; k > j; j++) h[h.length] = i[j];
        i.length = 0;
        for (var j = 0; d > j; j++) {
            var l = c[j], m = l.attachment;
...
!function (a) {
    var b = function (b) {
        function c(c, d, e) {
            ...
            var g = new a.SpineTextureLoader(c), h = new spine.Atlas(c.cache.getText(f.atlas), g),
                i = new spine.AtlasAttachmentLoader(h), j = new spine.SkeletonJson(i);
            ...
            for (var k = 0, l = this.skeleton.slots.length; l > k; k++) {
                var m = this.skeleton.slots[k], n = m.attachment, o = new Phaser.Group(c);
                if (this.slotContainers.push(o), this.add(o), n instanceof spine.RegionAttachment) {
                    var p = n.rendererObject.name, q = this.createSprite(m, n);
        ...
        return __extends(c, b), Object.defineProperty(c.prototype, "autoUpdate", {
            ...
            if (void 0 !== a) {
                ...
                for (var d = 0, e = c.length; e > d; d++) {
                    var f = c[d], g = f.attachment, h = this.slotContainers[d];
                    if (g) {
                        var i = g.type;
                        if (i === spine.AttachmentType.region) {
                            ...
                            if (!f.currentMeshName || f.currentMeshName !== g.name) {
                                var m = g.name;
                                if (void 0 !== f.currentMesh && (f.currentMesh.visible = !1), f.meshes = f.meshes || {}, void 0 !== f.meshes[m]) f.meshes[m].visible = !0; else {
            ...
            var c = b.rendererObject, d = c.page.rendererObject,
                e = new PIXI.Rectangle(c.x, c.y, c.rotate ? c.height : c.width, c.rotate ? c.width : c.height),
                f = new PIXI.Texture(d, e), g = new Phaser.Sprite(this.game, 0, 0, f), h = c.rotate ? .5 * Math.PI : 0;
            ...
            var c = b.rendererObject, d = c.page.rendererObject, e = new PIXI.Texture(d), f = new PIXI.Strip(e);
            ...
            if (0 !== b.length) {
                for (var d = new spine.Skin(a), e = 0; e < b.length; e++) {
                    var f = b[e], g = this.skeleton.data.findSkin(f);
                    if (!g) return;
                    for (var h in g.attachments) {
                        var i = h.split(":"), j = i[0], k = i[1], l = g.attachments[h];
